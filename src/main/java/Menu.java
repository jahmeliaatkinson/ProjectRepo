	...
	public static void main(String[] args) {
		...
		while(choice != 7){
			...
			if(choice == 1) {
				...
				Employee employee = new Employee(10, 10, 10, "Luna White", 30 ,"Trainer");
				String result = employeeServices.addEmployee(employee);

				System.out.println(employeeServices.equals(employeeServices));
				System.out.println(employeeServices2 == employeeServices2);
